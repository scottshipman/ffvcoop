...
#####  Palette URL: http://paletton.com/#uid=52-0I0klllla8uRnhCtqWg-dN9g
colors go light to dark
*** Primary color: Green

   shade 0 = #629833 = rgb( 98,152, 51) = rgba( 98,152, 51,1)
   shade 1 = #B7DC96 = rgb(183,220,150) = rgba(183,220,150,1)
   shade 2 = #90EA40 = rgb(144,234, 64) = rgba(144,234, 64,1)
   shade 3 = #427613 = rgb( 66,118, 19) = rgba( 66,118, 19,1)
   shade 4 = #334226 = rgb( 51, 66, 38) = rgba( 51, 66, 38,1)

*** Secondary color (1): Blue

   shade 0 = #226765 = rgb( 34,103,101) = rgba( 34,103,101,1)
   shade 1 = #669594 = rgb(102,149,148) = rgba(102,149,148,1)
   shade 2 = #31B2AD = rgb( 49,178,173) = rgba( 49,178,173,1)
   shade 3 = #0D504E = rgb( 13, 80, 78) = rgba( 13, 80, 78,1)
   shade 4 = #1A2D2C = rgb( 26, 45, 44) = rgba( 26, 45, 44,1)

*** Secondary color (2): Yellow-Green

   shade 0 = #AAA939 = rgb(170,169, 57) = rgba(170,169, 57,1)
   shade 1 = #F6F5A8 = rgb(246,245,168) = rgba(246,245,168,1)
   shade 2 = #FFFE46 = rgb(255,254, 70) = rgba(255,254, 70,1)
   shade 3 = #848315 = rgb(132,131, 21) = rgba(132,131, 21,1)
   shade 4 = #4A4A2A = rgb( 74, 74, 42) = rgba( 74, 74, 42,1)
